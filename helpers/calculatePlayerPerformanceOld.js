export const calculatePlayerPerformance = (games) => {
  ...
  function initializePlayer(player) {
    if (!players[player]) {
      players[player] = {
        lastActive: null, //Added to calculatePlayerPerformance
        numberOfWins: 0, //Added to calculatePlayerPerformance
        numberOfLosses: 0, //Added to calculatePlayerPerformance
        totalPoints: 0, //Added to calculatePlayerPerformance
        numberOfGamesPlayed: 0, //Added to calculatePlayerPerformance
        resultLog: [], //Added to calculatePlayerPerformance
        highestWinStreak: 0, //Added to calculatePlayerPerformance
        highestLossStreak: 0, //Added to calculatePlayerPerformance
        XP: 0, //Added to calculatePlayerPerformance
        totalPointEfficiency: 0, //Added to calculatePlayerPerformance
        pointEfficiency: 0, //Added to calculatePlayerPerformance
        currentStreak: {
          //Added to calculatePlayerPerformance
          type: null, // //Added to calculatePlayerPerformance
          count: 0, //Added to calculatePlayerPerformance
        },
        winStreak3: 0, //Added to calculatePlayerPerformance
        winStreak5: 0, // //Added to calculatePlayerPerformance
        winStreak7: 0, //Added to calculatePlayerPerformance
        demonWin: 0, //Added to calculatePlayerPerformance
      };
    }
  }
